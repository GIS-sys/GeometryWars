...
class GameObject {
  public:
    ...
    virtual bool is_inside(float x, float y, int buffer_width, int buffer_height) { return false; }
    virtual bool is_outside(float x, float y, int buffer_width, int buffer_height) { return !is_inside(x, y, buffer_width, buffer_height); }
